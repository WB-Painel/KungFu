  ...
  let SlotsDaPreviewCriado = false;
	...
	function MODIFICAR_SLOTS_DA_LISTA1(WIDTH){
	...
	function MODIFICAR_SLOTS_DA_LISTA2(WIDTH){
	...
	LISTA_2.style.width = LISTA_2.clientWidth/2+"px";
	
	LISTA_2.style.left = 0+"px";
	LISTA_2.style.width = WIDTH/5+WIDTH/40+"px";
	
	let i = 0;
	let b = LISTA_2.children.length;
	while(i<b){
	...
	function MODIFICAR_SLOTS_DA_LISTA3(WIDTH){
	...
	LISTA_3.style.width = LISTA_3.clientWidth/2+"px";
	
	LISTA_3.style.left = 0+"px";
	LISTA_3.style.width = WIDTH/5+WIDTH/40+"px";
	
	let i = 0;
	let b = LISTA_3.children.length;
	while(i<b){
	...
	MODIFICAR_SLOTS_DA_LISTA1(WIDTH);
	...
	MODIFICAR_SLOTS_DA_LISTA2(WIDTH);
	...
	MODIFICAR_SLOTS_DA_LISTA3(WIDTH);
