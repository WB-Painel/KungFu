  ...
  let SlotsDaPreviewCriado = false;
	...
	function MODIFICAR_SLOTS_DA_LISTA1(LISTA_1){
	let i = 0;
	...
	function MODIFICAR_SLOTS_DA_LISTA2(LISTA_2){
	let i = 0;
	let b = LISTA_1.children.length;
	while(i<b){
	...
	function MODIFICAR_SLOTS_DA_LISTA3(LISTA_3){
	let i = 0;
	let b = LISTA_1.children.length;
	while(i<b){
	...
	MODIFICAR_SLOTS_DA_LISTA1(LISTA_1);
	...
	MODIFICAR_SLOTS_DA_LISTA2(LISTA_2);
	...
	MODIFICAR_SLOTS_DA_LISTA3(LISTA_3);
