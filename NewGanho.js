function NewGanho(
			  ...
			  let Valor_1 = VALORES_ARRAY[1];
			  let Valor_2 = VALORES_ARRAY[2];
			  let Valor_3 = VALORES_ARRAY[3];
			  let Valor_4 = VALORES_ARRAY[4];
			  let Valor_5 = VALORES_ARRAY[5];
			  let Valor_6 = VALORES_ARRAY[6];
