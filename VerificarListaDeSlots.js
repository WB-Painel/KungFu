...
function VerificarListaDeSlots(){
	  ...
	  LISTA_DE_SLOTS_IGUAIS = 0;
	 
	  IMAGEM_DO_PERSONAGEM_DOS_SLOTS_IGUAIS = "po.png";
	  ...
	  ANIMATION_TOP_RIGHT_TO_BOTTOM_LEFT(ITEM_1_LIST_1,ITEM_2_LIST_2,ITEM_3_LIST_3, LISTA_1, LISTA_5, LISTA_9);
	  //
	
	
	  //BOTTOM RIGHT TO TOP LEFT
	  ANIMATION_BOTTOM_RIGHT_TO_TOP_LEFT(ITEM_3_LIST_1,ITEM_2_LIST_2,ITEM_1_LIST_3, LISTA_7,LISTA_5,LISTA_3);
	  //
	  
	  
	  //TOP RIGHT TO TOP LEFT 1
	  ANIMATION_TOP_RIGHT_TO_TOP_LEFT(ITEM_1_LIST_1,ITEM_1_LIST_2,ITEM_1_LIST_3,LISTA_1,LISTA_2,LISTA_3);
	  //
	  
		
	  //CENTER RIGHT TO CENTER LEFT
	  ANIMATION_CENTER_RIGHT_TO_CENTER_LEFT(ITEM_2_LIST_1,ITEM_2_LIST_2,ITEM_2_LIST_3, LISTA_4,LISTA_5,LISTA_6);
	  //
	  
	  
	  //BOTTOM RIGHT TO BOTTOM LEFT
	  ANIMATION_BOTTOM_RIGHT_TO_BOTTOM_LEFT(ITEM_3_LIST_1,ITEM_3_LIST_2,ITEM_3_LIST_3, LISTA_7,LISTA_8,LISTA_9);
	  //
	  
	  
	  //VERIFICAR SE NÃO TEM NENHUMA LISTA DE SLOTS IGUAIS
	  VERIFICAR_SE_NAO_TEM_NENHUMA_LISTA_DE_SLOTS_IGUAIS(LISTA_DE_SLOTS_IGUAIS);
	  //
	  
	  
	  //VERIFICAR SE TEM LISTA DE SLOTS IGUAIS
	  VERIFICAR_SE_TEM_LISTA_DE_SLOTS_IGUAIS(LISTA_1_FUNDO,LISTA_2_FUNDO,LISTA_3_FUNDO,LISTA1,LISTA2,LISTA3);
	  //
	...
	function ANIMATION_BOTTOM_RIGHT_TO_TOP_LEFT(ITEM_3_LIST_1,ITEM_2_LIST_2,ITEM_1_LIST_3, LISTA_7,LISTA_5,LISTA_3){
	...
	function ANIMATION_TOP_RIGHT_TO_TOP_LEFT(ITEM_1_LIST_1,ITEM_1_LIST_2,ITEM_1_LIST_3,LISTA_1,LISTA_2,LISTA_3){
	  if(ITEM_1_LIST_1==ITEM_1_LIST_2&&ITEM_1_LIST_2==ITEM_1_LIST_3){
	...
	function ANIMATION_CENTER_RIGHT_TO_CENTER_LEFT(ITEM_2_LIST_1,ITEM_2_LIST_2,ITEM_2_LIST_3, LISTA_4,LISTA_5,LISTA_6){
	...
	function ANIMATION_BOTTOM_RIGHT_TO_BOTTOM_LEFT(ITEM_3_LIST_1,ITEM_3_LIST_2,ITEM_3_LIST_3,LISTA_7,LISTA_8,LISTA_9){
	...
	function VERIFICAR_SE_NAO_TEM_NENHUMA_LISTA_DE_SLOTS_IGUAIS(LISTA_DE_SLOTS_IGUAIS){
	...
	function VERIFICAR_SE_TEM_LISTA_DE_SLOTS_IGUAIS(LISTA_1_FUNDO,LISTA_2_FUNDO,LISTA_3_FUNDO,LISTA1,LISTA2,LISTA3){
	  if(LISTA_DE_SLOTS_IGUAIS>0){
